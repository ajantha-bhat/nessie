...
public class TestUtil {
  ...
  public static Map<String, String> getAuthzTestConfigurations() {
    return ImmutableMap.<String, String>builder()
      .put("%test.nessie.server.authorization.rules.allow_all",
