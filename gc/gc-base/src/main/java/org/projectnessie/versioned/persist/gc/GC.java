...
public interface GC {
  ...
  interface Builder {
     ...
     * as eligible for GC.
     *
     * <p>This is effectively a shortcut for {@link
     * #addCutOffTimeStampPerReferenceComputation(Function) addPruneBeforeCompute(ref ->
     * defaultPruneBefore)}.
     *
     * @see #addCutOffTimeStampPerReferenceComputation(Function)
     */
     ...
     */
    Builder addCutOffTimeStampPerReferenceComputation(
