...
abstract class AbstractGCTest {
  ...
  protected void performGc(Dataset dataset, DatabaseAdapter databaseAdapter) {
    ...
    ContentValuesCollector<BaseExpiredContentValues> contentValuesCollector =
        new ContentValuesCollector<>(BaseExpiredContentValues::new);
    GC gc =
        GC.builder()
            ...
            .build();
    GCResult<BaseExpiredContentValues> gcResult = gc.performGC(contentValuesCollector);
